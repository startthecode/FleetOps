package org.samtar.warehouse.drivers.dto.req;
...
public record CreateDriverReqDto(
        ...
        @NotNull(message = "Drive rating is required")
        @Min(value = 1, message = "Drive rating must be at least 1")
        @Max(value = 10, message = "Drive rating must be at most 10")
        Integer driveRating,

        @NotNull(message = "haveDrivingLicence is required")
